                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ Request::is('*data-polsek*') ? 'active' : '' }}" href="/data-polsek">
									<i class="fa fa-fw fa-folder-open "></i>Data Polsek
								</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ Request::is('*data-ineternet*') ? 'active' : '' }}" href="/data-internet">
									<i class="fa fa-fw fa-wifi"></i>Data Pelanggan Internet
								</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ Request::is('*data-barang*') ? 'active' : '' }}" href="/data-barang">
									<i class="fa fa-fw fa-tags"></i>Data Barang
								</a>
                            </li>
                            <li class="nav-item">
